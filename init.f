...
C	1.Declare Variables!
     ...
     +     Ev_CT1,Ev_CT2,Ev_HH,Ev_HT,Ev_HL1,Ev_HL2,Ev_HC
      ...
      double precision Ec_HH, Ec_HT, Ec_HL1, Ec_HL2, Ec_HC
...
cccccccccccccccccccccccccccccccccc
     ...
     +                force_tBend_X,force_tBend_Y,force_tBend_Z,         
     +                t_Eb_num,t_Ea_num,Eb_tc_num,           
     +                 np,myid,ierr)             
            

        
              call   diffcent(n_c,nc3,n,n3,type,r,ro,d1,go,a,b,c,
     +         aold,bold,cold,
     +        alpha,beta,gamma,length,a_dna,b_dna,c_dna,
     +        alpha_p,beta_p,gamma_p,
     ...
     +                force_dnaStr_X,force_dnaStr_Y,force_dnaStr_Z,   ! Pass the analytic force values to the function
     +                force_dnaBend_X,force_dnaBend_Y,force_dnaBend_Z,
     +             force_dnaTwist_X,force_dnaTwist_Y,force_dnaTwist_Z,
     +    np,myid,ierr)
